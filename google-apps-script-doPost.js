...
function doPost(e) {
  ...
  try {
    ...
    var headers = [
      'DATA/HORA', 'SCORE', 'RESULTADO',
      'NOME', 'EMPRESA', 'WHATSAPP', 'EMAIL',
      'utm_source', 'utm_medium', 'utm_campaign',
      'FUNCIONARIOS', 'Q2_value',
      'FATURAMENTO', 'Q3_value',
      'REGIME', 'Q4_value',
      'SISTEMA/FINANCEIRO', 'Q7_value'
    ];
    ...
    var row = [
      ...
      utm.utm_medium || '',
      utm.utm_campaign || '',
      // FUNCIONARIOS = label correspondente a R2
      payload.Q2_label || '',
      payload.Q2_value || '',
      // FATURAMENTO = label correspondente a R3
      payload.Q3_label || '',
      payload.Q3_value || '',
      // REGIME = label correspondente a Q1
      payload.Q4_label || '',
      payload.Q4_value || '',
      // SISTEMA/FINANCEIRO = label correspondente a Q4
      payload.Q7_label || '',
      payload.Q7_value || ''
    ];
